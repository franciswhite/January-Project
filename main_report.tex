...
The crucial observation to make here is that the agents could have done better. Consider altering $<S_3,R_3>$ so that neither $m_{tree}$ are $m_{stone}$ ever played. 
\begin{equation*}
S_*=
\bordermatrix{
            & & & &    \cr
