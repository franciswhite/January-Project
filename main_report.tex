...
In contrast to Mr Trump, the authors of the present paper had time. We provide a formal framework in order to analyze the pragmatic phenomenon of hurtful use of language. Our model will yield three core results: First, it offers a formal explanation for the reason why offensive use of language is so persistent. Second, it will become apparent that this state is not optimal. Third,  it will be seen that the degree of ''empathy'' language users exhibit is of crucial importance. 
