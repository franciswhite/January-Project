...
\textbf{explain why priors are used}
...
\end{equation*}
The naive sender has no principle to decide between sending either $m_{eco}$ or $m_{tree}$ when observing $t_{eco}$. This is represented by her sending each message half of the time. So she plays a mixed strategy. The receiver's actions are clearly determined by a pure strategy.\\
